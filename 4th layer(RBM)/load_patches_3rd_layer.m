...
% end
f1=load([CIFAR_DIR '/hidstates3rd_sandstone_(p2p2)_(24f40f144f6ws9ws9wsPb030001).mat']);
xtr = double([f1.xtr;]);
% xtr = gpuArray(xtr);
...
clear f1;
fname = sprintf('hidstates4th_sandstone_(p2p2)_(24f40f144fPb030001)_6ws9ws9ws%dws',ws);
