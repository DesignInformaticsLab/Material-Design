...
load('WB_nowh_P20Pb01_rot12_2f_6ws_alloy_w6_b02_rot_nrot12_pb0.1_pl20_iter_4000.mat');
sigma=gather(weight.sigma);
filters_t=gather(weight.vishid);
load('Tlist_12r_6ws_pi12.mat');
% 
load('WB_2nd_pool2_hidstate_(2f40f6ws9ws12rP20P20Pb01)_alloy_w9_b40_trans_ntx1_gr1_pb0.1_pl20_iter_2000.mat')
