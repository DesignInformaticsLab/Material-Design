for ii = 1:100
fname = sprintf('hidstate_2ndlayer(1stlayerpool2)_WB_nowh_(2f40f6ws9ws12rP20P10Pb01)_%d',ii);
...
fname = sprintf('hidstate_2ndlayer(1stlayerpool2)_WB_nowh_(2f40f6ws9ws12rP20P10Pb01)');
