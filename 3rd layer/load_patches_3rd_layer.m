...
% end
f1=load([CIFAR_DIR '/hidstate_2ndlayer(1stp2)_POOL2(hardsphere)_(2f40f6ws9ws12rP20P10Pb01).mat']);
xtr = double([f1.pool;]);
% xtr = gpuArray(xtr);
...
clear f1;
fname = sprintf('hidstate_2ndlayer(1stp2)_POOL2(hardsphere)_(2f40f72f6ws9ws)_ws%d',ws);
