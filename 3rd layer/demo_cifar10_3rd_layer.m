...
if strcmp(params.txtype, 'rot'),
    fname = sprintf('3rd_POOL2(imresize)_(real_bibi)_(2f40f144f6ws9ws9ws12rP20P10P10Pb01)_%s_w%d_b%02d_%s_nrot%d_pb%g_pl%g', ...
...
elseif strcmp(params.txtype, 'trans') || strcmp(params.txtype, 'scale'),
    fname = sprintf('3rd_POOL2(imresize)_(real_bibi)_(2f40f144f6ws9ws9ws12rP20P10P10Pb01)_%s_w%d_b%02d_%s_ntx%d_gr%d_pb%g_pl%g', ...
