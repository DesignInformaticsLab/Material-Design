...
addpath('utils','function_code','hidstate 3rd sandstone layer p2p2 (2f40f144f6ws9ws9wsPb010000)')
% One=load('WB_real_alloy_w24_b02_rot_nrot24_pb0.1_pl0.1_iter_500.mat');
One=load('alloy2_nonor_ws12_f24_alloy_w6_b24_rot_nrot1_pb0.1_pl10_iter_1000.mat');
...
%     hidstate=reshape(im2bw(reconst_rand_4to3(:,ii)),[1296 144])';

%     hidstate=reshape(im2bw(hidstate_sim_f(:,ii)),[288 373248/288]);
%     hidstate=reshape(double(im2bw(reconst_4to3(:,ii),0.1)),[373248/288 288])';
    
    hidstate=reshape((reconst_rand_4to3(:,ii)),[1296 144])';
    hidstate=double(reshape(hidstate,[144 1 1296]));
