for ii = 1:100
fname = sprintf('hidstates3nd_WB_nowh(p2p2)_imresize_(2f40f288f6ws9ws9ws12rP20P10P10Pb01)_%d',ii);
...
fname = sprintf('hidstates3nd_WB_nowh(p2p2)_imresize_(2f40f288f6ws9ws9ws12rP20P10P10Pb01)');
