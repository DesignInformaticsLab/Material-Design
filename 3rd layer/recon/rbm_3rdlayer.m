%% crbm_inference
function [poshidexp2] = rbm_3rdlayer(image, patch, W, ~, hbias_vec, params, ii)
    rng(0);
...
%     end
    ...
    hbiasmat = reshape(repmat(hbias_vec(:,1:numtx), [1, 1, batchsize/numchannels]), numhid, numtx*batchsize/numchannels);
