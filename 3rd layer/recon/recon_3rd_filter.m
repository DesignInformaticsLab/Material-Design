...
load('3rd_POOL2_(real_bibi)_(2f40f24f6ws9ws9ws12rP20P10P40Pb01)_alloy_w9_b24_trans_ntx1_gr1_pb0.1_pl10_iter_1000.mat')
numch = 40;
...
%         temp2=conv2(filter_t_temp,filter_3rd,'same');
        temp3=conv2(filter_3rd,filter_t_temp,'full');
...
figure(103); subplot(4,6,j),display_network(reshape(negdata,size(negdata,1)*size(negdata,2),1));
